...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher_weight', type=float, default=100, help='the weight of the teacher degradation loss')
    
    
    #Modification 
    parser.add_argument('--rec_weight',type=float,default=1.0,help='weight for the self‑reconstruction loss term')
